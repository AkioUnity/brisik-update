...
class Chat extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    const { messages, presence, online, opponentData } = nextProps;
  ...
  componentDidMount() {
    const { messages, presence, online } = this.props;
...
Chat.id = 'com.eSportsGlobalGamers.Chat';
